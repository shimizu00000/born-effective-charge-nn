...
PairNNP3v_vf::PairNNP3v_vf(LAMMPS *lmp) : Pair(lmp)
{
...
/* ---------------------------------------------------------------------- */
void PairNNP3v_vf::compute(int eflag, int vflag)
{
  ...
  for (ii = 0; ii < inum; ii++) {
    ...
    f[i][0] += fx * eforce_z; f[i][1] += fy * eforce_z; f[i][2] += fz * eforce_z;
    zval=x[i][2];
    ...
    for (jj = 0; jj < numshort; jj++) {
      ...
      f[j][0] += fx * eforce_z; f[j][1] += fy * eforce_z; f[j][2] += fz * eforce_z;
      zval = x[j][2];
      while (zval < zlo || zval > zhi){
        if (zval < zlo){
	  zval += zhi;
...
void PairNNP3v_vf::settings(int narg, char **/*arg*/)
{
...
void PairNNP3v_vf::coeff(int narg, char **arg)
{
...
double PairNNP3v_vf::init_one(int i, int j)
{
...
void PairNNP3v_vf::read_file(char *file)
{
...
void PairNNP3v_vf::setup_params()
{
...
void PairNNP3v_vf::sf_g2(int i, int j, double rij,
...
double PairNNP3v_vf::fc(double rij)
{
...
double PairNNP3v_vf::fc_deriv(double rij, double xi, double xj)
{
...
/* ---------------------------------------------------------------------- */
void PairNNP3v_vf::sf_g5(int i, int j, int k, double rij, double rik,
                     double x1, double y1, double z1,
                     double x2, double y2, double z2,
...
/* ---------------------------------------------------------------------- */
void PairNNP3v_vf::hdnnp_e_a(double *(&g2_a_a),  int num_g2_a_a,
...
/* ---------------------------------------------------------------------- */
void PairNNP3v_vf::hdnnp_f_a(double ***(&g2_deriv_a_a),  int num_g2_a_a,
...
/* ---------------------------------------------------------------------- */
void PairNNP3v_vf::hdnnp_e_b(double *(&g2_b_a),  int num_g2_b_a,
...
/* ---------------------------------------------------------------------- */
void PairNNP3v_vf::hdnnp_f_b(double ***(&g2_deriv_b_a),  int num_g2_b_a,
...
/* ---------------------------------------------------------------------- */
void PairNNP3v_vf::hdnnp_e_c(double *(&g2_c_a),  int num_g2_c_a,
...
/* ---------------------------------------------------------------------- */
void PairNNP3v_vf::hdnnp_f_c(double ***(&g2_deriv_c_a),  int num_g2_c_a,
