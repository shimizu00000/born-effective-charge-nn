...
PairStyle(nnp3v,PairNNP3v)

#else

#ifndef LMP_PAIR_NNP3V_H
#define LMP_PAIR_NNP3V_H

#include "pair.h"

namespace LAMMPS_NS {

class PairNNP3v : public Pair {
 public:
  PairNNP3v(class LAMMPS *);
  virtual ~PairNNP3v();
 ...
 protected:
  ...
  double *zeta5_c_aa,*zeta5_c_ab,*zeta5_c_ac,
         ...
         *zeta5_c_cc;
  double *lambda5_a_aa,*lambda5_a_ab,*lambda5_a_ac,
         *lambda5_a_bb,*lambda5_a_bc,
         *lambda5_a_cc;
  double *lambda5_b_aa,*lambda5_b_ab,*lambda5_b_ac,
         *lambda5_b_bb,*lambda5_b_bc,
         *lambda5_b_cc;
  double *lambda5_c_aa,*lambda5_c_ab,*lambda5_c_ac,
         *lambda5_c_bb,*lambda5_c_bc,
         *lambda5_c_cc;
