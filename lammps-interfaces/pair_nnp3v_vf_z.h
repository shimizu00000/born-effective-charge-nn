...
PairStyle(nnp3v_vf_z,PairNNP3v_vf_z)

#else

#ifndef LMP_PAIR_NNP3V_VF_Z_H
#define LMP_PAIR_NNP3V_VF_Z_H

#include "pair.h"

namespace LAMMPS_NS {

class PairNNP3v_vf_z : public Pair {
 public:
  PairNNP3v_vf_z(class LAMMPS *);
  virtual ~PairNNP3v_vf_z();
