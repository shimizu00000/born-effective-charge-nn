...
double precision const_a_ar(network_x(1)*network_x(2)*network_x(3))
double precision const_b_ar(network_x(1)*network_x(2)*network_x(3))
double precision const_c_ar(network_x(1)*network_x(2)*network_x(3))
double precision const_d_ar(network_x(1)*network_x(2)*network_x(3))
double precision const_e_ar(network_x(1)*network_x(2)*network_x(3))

double precision const1_ar(natom_x, network_x(2)*network_x(3))
double precision const2_ar(natom_x, network_x(1)*network_x(2)*network_x(3))
double precision const3_ar(natom_x, network_x(1)*network_x(2)*network_x(3))

double precision array_o1_ar1(network_x(1), network_x(2)*network_x(3))
double precision array_o1_ar2(network_x(1), network_x(1)*network_x(2)*network_x(3))

double precision array_o2_ar(network_x(2), network_x(1)*network_x(2)*network_x(3))
