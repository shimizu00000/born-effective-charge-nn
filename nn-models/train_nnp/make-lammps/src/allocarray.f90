...
subroutine allocate_3( &
           ...
           tag5_x_xx, eta5_x_xx, theta5_x_xx, zeta5_x_xx, lambda5_x_xx, &
           tag5_x_xy, eta5_x_xy, theta5_x_xy, zeta5_x_xy, lambda5_x_xy, &
           tag5_x_xz, eta5_x_xz, theta5_x_xz, zeta5_x_xz, lambda5_x_xz, &
           tag5_x_yy, eta5_x_yy, theta5_x_yy, zeta5_x_yy, lambda5_x_yy, &
           tag5_x_yz, eta5_x_yz, theta5_x_yz, zeta5_x_yz, lambda5_x_yz, &
           tag5_x_zz, eta5_x_zz, theta5_x_zz, zeta5_x_zz, lambda5_x_zz, &
...
double precision,allocatable,dimension(:) :: &
 ...
 call param_read_g5( sf_name, g5_x_xx_maxmin, eta5_x_xx, theta5_x_xx, zeta5_x_xx, lambda5_x_xx, num_g5_x_xx )
 sf_name = trim(adjustl( tag5_x_xy ))
 call param_read_g5( sf_name, g5_x_xy_maxmin, eta5_x_xy, theta5_x_xy, zeta5_x_xy, lambda5_x_xy, num_g5_x_xy )
 sf_name = trim(adjustl( tag5_x_xz ))
 call param_read_g5( sf_name, g5_x_xz_maxmin, eta5_x_xz, theta5_x_xz, zeta5_x_xz, lambda5_x_xz, num_g5_x_xz )
 sf_name = trim(adjustl( tag5_x_yy ))
 call param_read_g5( sf_name, g5_x_yy_maxmin, eta5_x_yy, theta5_x_yy, zeta5_x_yy, lambda5_x_yy, num_g5_x_yy )
 sf_name = trim(adjustl( tag5_x_yz ))
 call param_read_g5( sf_name, g5_x_yz_maxmin, eta5_x_yz, theta5_x_yz, zeta5_x_yz, lambda5_x_yz, num_g5_x_yz )
 sf_name = trim(adjustl( tag5_x_zz ))
 call param_read_g5( sf_name, g5_x_zz_maxmin, eta5_x_zz, theta5_x_zz, zeta5_x_zz, lambda5_x_zz, num_g5_x_zz )
...
subroutine allocate_4( &
           ...
           tag5_x_xy, eta5_x_xy, theta5_x_xy, zeta5_x_xy, lambda5_x_xy, &
           tag5_x_xz, eta5_x_xz, theta5_x_xz, zeta5_x_xz, lambda5_x_xz, &
           tag5_x_xv, eta5_x_xv, theta5_x_xv, zeta5_x_xv, lambda5_x_xv, &
           tag5_x_yy, eta5_x_yy, theta5_x_yy, zeta5_x_yy, lambda5_x_yy, &
           tag5_x_yz, eta5_x_yz, theta5_x_yz, zeta5_x_yz, lambda5_x_yz, &
           tag5_x_yv, eta5_x_yv, theta5_x_yv, zeta5_x_yv, lambda5_x_yv, &
           tag5_x_zz, eta5_x_zz, theta5_x_zz, zeta5_x_zz, lambda5_x_zz, &
           tag5_x_zv, eta5_x_zv, theta5_x_zv, zeta5_x_zv, lambda5_x_zv, &
           tag5_x_vv, eta5_x_vv, theta5_x_vv, zeta5_x_vv, lambda5_x_vv, &
...
double precision,allocatable,dimension(:) :: &
 ...
 call param_read_g5( sf_name, g5_x_xv_maxmin, eta5_x_xv, theta5_x_xv, zeta5_x_xv, lambda5_x_xv, num_g5_x_xv )
 sf_name = trim(adjustl( tag5_x_yy ))
 call param_read_g5( sf_name, g5_x_yy_maxmin, eta5_x_yy, theta5_x_yy, zeta5_x_yy, lambda5_x_yy, num_g5_x_yy )
 sf_name = trim(adjustl( tag5_x_yz ))
 call param_read_g5( sf_name, g5_x_yz_maxmin, eta5_x_yz, theta5_x_yz, zeta5_x_yz, lambda5_x_yz, num_g5_x_yz )
 sf_name = trim(adjustl( tag5_x_yv ))
 call param_read_g5( sf_name, g5_x_yv_maxmin, eta5_x_yv, theta5_x_yv, zeta5_x_yv, lambda5_x_yv, num_g5_x_yv )
 sf_name = trim(adjustl( tag5_x_zz ))
 call param_read_g5( sf_name, g5_x_zz_maxmin, eta5_x_zz, theta5_x_zz, zeta5_x_zz, lambda5_x_zz, num_g5_x_zz )
 sf_name = trim(adjustl( tag5_x_zv ))
 call param_read_g5( sf_name, g5_x_zv_maxmin, eta5_x_zv, theta5_x_zv, zeta5_x_zv, lambda5_x_zv, num_g5_x_zv )
 sf_name = trim(adjustl( tag5_x_vv ))
 call param_read_g5( sf_name, g5_x_vv_maxmin, eta5_x_vv, theta5_x_vv, zeta5_x_vv, lambda5_x_vv, num_g5_x_vv )
