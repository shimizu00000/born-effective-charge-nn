...
do i = 1, num_g5_a_ac
  write(99,'(4F15.10)') eta5_a_ac(i), theta5_a_ac(i), zeta5_a_ac(i), lambda5_a_ac(i)
enddo
write(99,*)" "
...
do i = 1, num_g5_a_bc
  write(99,'(4F15.10)') eta5_a_bc(i), theta5_a_bc(i), zeta5_a_bc(i), lambda5_a_bc(i)
enddo
write(99,*)" "
write(99,'(A13)')"param_g5_a_cc"
do i = 1, num_g5_a_cc
  write(99,'(4F15.10)') eta5_a_cc(i), theta5_a_cc(i), zeta5_a_cc(i), lambda5_a_cc(i)
enddo
write(99,*)" "
...
do i = 1, num_g5_b_ac
  write(99,'(4F15.10)') eta5_b_ac(i), theta5_b_ac(i), zeta5_b_ac(i), lambda5_b_ac(i)
enddo
write(99,*)" "
...
do i = 1, num_g5_b_bc
  write(99,'(4F15.10)') eta5_b_bc(i), theta5_b_bc(i), zeta5_b_bc(i), lambda5_b_bc(i)
enddo
write(99,*)" "
write(99,'(A13)')"param_g5_b_cc"
do i = 1, num_g5_b_cc
  write(99,'(4F15.10)') eta5_b_cc(i), theta5_b_cc(i), zeta5_b_cc(i), lambda5_b_cc(i)
enddo
write(99,*)" "
...
do i = 1, num_g5_c_aa
  write(99,'(4F15.10)') eta5_c_aa(i), theta5_c_aa(i), zeta5_c_aa(i), lambda5_c_aa(i)
enddo
write(99,*)" "
write(99,'(A13)')"param_g5_c_ab"
do i = 1, num_g5_c_ab
  write(99,'(4F15.10)') eta5_c_ab(i), theta5_c_ab(i), zeta5_c_ab(i), lambda5_c_ab(i)
enddo
write(99,*)" "
write(99,'(A13)')"param_g5_c_ac"
do i = 1, num_g5_c_ac
  write(99,'(4F15.10)') eta5_c_ac(i), theta5_c_ac(i), zeta5_c_ac(i), lambda5_c_ac(i)
enddo
write(99,*)" "
write(99,'(A13)')"param_g5_c_bb"
do i = 1, num_g5_c_bb
  write(99,'(4F15.10)') eta5_c_bb(i), theta5_c_bb(i), zeta5_c_bb(i), lambda5_c_bb(i)
enddo
write(99,*)" "
write(99,'(A13)')"param_g5_c_bc"
do i = 1, num_g5_c_bc
  write(99,'(4F15.10)') eta5_c_bc(i), theta5_c_bc(i), zeta5_c_bc(i), lambda5_c_bc(i)
enddo
write(99,*)" "
write(99,'(A13)')"param_g5_c_cc"
do i = 1, num_g5_c_cc
  write(99,'(4F15.10)') eta5_c_cc(i), theta5_c_cc(i), zeta5_c_cc(i), lambda5_c_cc(i)
enddo
write(99,*)" "
