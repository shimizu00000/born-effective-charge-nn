...
double precision Rij, g2_const_1, g2_deriv_1, g2_deriv_2
...
double precision,parameter :: pi = 4.0d0 * datan(1.0d0)
 ...
 do ig2 = 1, num_g2
   ...
   g2(ii,ig2) = g2(ii,ig2) + g2_const_1 * fc(Rij) * (posi1_z - posi2_z) / Rij
   g2_deriv_1 = -2.0d0 * eta2(ig2) * ( Rij - rs2(ig2) ) * fc(Rij) * (posi1_z - posi2_z) / Rij &
                -0.50d0 * ( pi / Rc ) * dsin( ( pi * Rij / Rc ) ) * (posi1_z - posi2_z) / Rij &
                -(posi1_z - posi2_z) * fc(Rij) / Rij**2
   g2_deriv_2 = fc(Rij) / Rij
