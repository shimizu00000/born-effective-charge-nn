subroutine sf_3( posi, xlattice, ylattice, zlattice, &
    g2_x_x,  eta2_x_x,  rs2_x_x, &
    g2_x_y,  eta2_x_y,  rs2_x_y, &
    g2_x_z,  eta2_x_z,  rs2_x_z, &
    g5_x_xx, eta5_x_xx, theta5_x_xx, zeta5_x_xx, R_s_x_xx, &
    g5_x_xy, eta5_x_xy, theta5_x_xy, zeta5_x_xy, R_s_x_xy, &
    g5_x_xz, eta5_x_xz, theta5_x_xz, zeta5_x_xz, R_s_x_xz, &
    g5_x_yy, eta5_x_yy, theta5_x_yy, zeta5_x_yy, R_s_x_yy, &
    g5_x_yz, eta5_x_yz, theta5_x_yz, zeta5_x_yz, R_s_x_yz, &
    g5_x_zz, eta5_x_zz, theta5_x_zz, zeta5_x_zz, R_s_x_zz, &
    g2_y_x,  eta2_y_x,  rs2_y_x, &
    g2_y_y,  eta2_y_y,  rs2_y_y, &
    g2_y_z,  eta2_y_z,  rs2_y_z, &
    g5_y_xx, eta5_y_xx, theta5_y_xx, zeta5_y_xx, R_s_y_xx, &
    g5_y_xy, eta5_y_xy, theta5_y_xy, zeta5_y_xy, R_s_y_xy, &
    g5_y_xz, eta5_y_xz, theta5_y_xz, zeta5_y_xz, R_s_y_xz, &
    g5_y_yy, eta5_y_yy, theta5_y_yy, zeta5_y_yy, R_s_y_yy, &
    g5_y_yz, eta5_y_yz, theta5_y_yz, zeta5_y_yz, R_s_y_yz, &
    g5_y_zz, eta5_y_zz, theta5_y_zz, zeta5_y_zz, R_s_y_zz, &
    g2_z_x,  eta2_z_x,  rs2_z_x, &
    g2_z_y,  eta2_z_y,  rs2_z_y, &
    g2_z_z,  eta2_z_z,  rs2_z_z, &
    g5_z_xx, eta5_z_xx, theta5_z_xx, zeta5_z_xx, R_s_z_xx, &
    g5_z_xy, eta5_z_xy, theta5_z_xy, zeta5_z_xy, R_s_z_xy, &
    g5_z_xz, eta5_z_xz, theta5_z_xz, zeta5_z_xz, R_s_z_xz, &
    g5_z_yy, eta5_z_yy, theta5_z_yy, zeta5_z_yy, R_s_z_yy, &
    g5_z_yz, eta5_z_yz, theta5_z_yz, zeta5_z_yz, R_s_z_yz, &
    g5_z_zz, eta5_z_zz, theta5_z_zz, zeta5_z_zz, R_s_z_zz, &
...
double precision Rij, Rik, g5_const_3 ! 追加
double precision rc
integer io_sf


do i = 1, natom
posi1(i,1) = posi(i,1) * xlattice  !分率座標を原点からの座標に直してる
posi1(i,2) = posi(i,2) * ylattice
posi1(i,3) = posi(i,3) * zlattice
enddo


!Repeating box カットオフに応じて1,2周り外まで用意してる
...
allocate( posi2( lattice_box * natom, 3 ) ) !posi2:周囲のやつを含めて宣言
...
!Rij_b = posi1(i,3) - posi2(atom1,3) ! 追加
...
if( j <= natom_x .and. &
  ...
  call sf_3_g5( g5_x_xx, g5_deriv_x_xx, &
                eta5_x_xx, R_s_x_xx, zeta5_x_xx, num_g5_x_xx, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
...
elseif( j <= natom_x .and. &
  ...
  call sf_3_g5( g5_x_xy, g5_deriv_x_xy, &
                eta5_x_xy, R_s_x_xy, zeta5_x_xy, num_g5_x_xy, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
                posi2(atom2,1), posi2(atom2,2), posi2(atom2,3), &
                natom, natom_x, natom_y, natom_z, &
...
elseif( j <= natom_x .and. &
  ...
  call sf_3_g5( g5_x_xz, g5_deriv_x_xz, &
                eta5_x_xz, R_s_x_xz, zeta5_x_xz, num_g5_x_xz, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
                posi2(atom2,1), posi2(atom2,2), posi2(atom2,3), &
                natom, natom_x, natom_y, natom_z, &
...
elseif( natom_x < j .and. j <= natom_x + natom_y .and. &
  ...
  call sf_3_g5( g5_x_yy, g5_deriv_x_yy, &
                eta5_x_yy, R_s_x_yy, zeta5_x_yy, num_g5_x_yy, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
                posi2(atom2,1), posi2(atom2,2), posi2(atom2,3), &
                natom, natom_x, natom_y, natom_z, &
...
elseif( natom_x < j .and. j <= natom_x + natom_y .and. &
  ...
  call sf_3_g5( g5_x_yz, g5_deriv_x_yz, &
                eta5_x_yz, R_s_x_yz, zeta5_x_yz, num_g5_x_yz, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
                posi2(atom2,1), posi2(atom2,2), posi2(atom2,3), &
                natom, natom_x, natom_y, natom_z, &
...
elseif( natom_x + natom_y < j .and. j <= natom_x + natom_y + natom_z .and. &
  ...
  call sf_3_g5( g5_x_zz, g5_deriv_x_zz, &
                eta5_x_zz, R_s_x_zz, zeta5_x_zz, num_g5_x_zz, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
                posi2(atom2,1), posi2(atom2,2), posi2(atom2,3), &
                natom, natom_x, natom_y, natom_z, &
...
if( j <= natom_x .and. &
  ...
  call sf_3_g5( g5_y_xx, g5_deriv_y_xx, &
                eta5_y_xx, R_s_y_xx, zeta5_y_xx, num_g5_y_xx, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
                posi2(atom2,1), posi2(atom2,2), posi2(atom2,3), &
                natom, natom_x, natom_y, natom_z, &
...
elseif( j <= natom_x .and. &
  ...
  call sf_3_g5( g5_y_xy, g5_deriv_y_xy, &
                eta5_y_xy, R_s_y_xy, zeta5_y_xy, num_g5_y_xy, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
                posi2(atom2,1), posi2(atom2,2), posi2(atom2,3), &
                natom, natom_x, natom_y, natom_z, &
...
elseif( j <= natom_x .and. &
  ...
  call sf_3_g5( g5_y_xz, g5_deriv_y_xz, &
                eta5_y_xz, R_s_y_xz, zeta5_y_xz, num_g5_y_xz, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
                posi2(atom2,1), posi2(atom2,2), posi2(atom2,3), &
                natom, natom_x, natom_y, natom_z, &
...
elseif( natom_x < j .and. j <= natom_x + natom_y .and. &
  ...
  call sf_3_g5( g5_y_yy, g5_deriv_y_yy, &
                eta5_y_yy, R_s_y_yy, zeta5_y_yy, num_g5_y_yy, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
                posi2(atom2,1), posi2(atom2,2), posi2(atom2,3), &
                natom, natom_x, natom_y, natom_z, &
...
elseif( natom_x < j .and. j <= natom_x + natom_y .and. &
  ...
  call sf_3_g5( g5_y_yz, g5_deriv_y_yz, &
                eta5_y_yz, R_s_y_yz, zeta5_y_yz, num_g5_y_yz, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
                posi2(atom2,1), posi2(atom2,2), posi2(atom2,3), &
                natom, natom_x, natom_y, natom_z, &
...
elseif( natom_x + natom_y < j .and. j <= natom_x + natom_y + natom_z .and. &
  ...
  call sf_3_g5( g5_y_zz, g5_deriv_y_zz, &
                eta5_y_zz, R_s_y_zz, zeta5_y_zz, num_g5_y_zz, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
                posi2(atom2,1), posi2(atom2,2), posi2(atom2,3), &
                natom, natom_x, natom_y, natom_z, &
...
if( j <= natom_x .and. &
  ...
  call sf_3_g5( g5_z_xx, g5_deriv_z_xx, &
                eta5_z_xx, R_s_z_xx, zeta5_z_xx, num_g5_z_xx, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
                posi2(atom2,1), posi2(atom2,2), posi2(atom2,3), &
                natom, natom_x, natom_y, natom_z, &
...
elseif( j <= natom_x .and. &
  ...
  call sf_3_g5( g5_z_xy, g5_deriv_z_xy, &
                eta5_z_xy, R_s_z_xy, zeta5_z_xy, num_g5_z_xy, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
                posi2(atom2,1), posi2(atom2,2), posi2(atom2,3), &
                natom, natom_x, natom_y, natom_z, &
...
elseif( j <= natom_x .and. &
  ...
  call sf_3_g5( g5_z_xz, g5_deriv_z_xz, &
                eta5_z_xz, R_s_z_xz, zeta5_z_xz, num_g5_z_xz, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
                posi2(atom2,1), posi2(atom2,2), posi2(atom2,3), &
                natom, natom_x, natom_y, natom_z, &
...
elseif( natom_x < j .and. j <= natom_x + natom_y .and. &
  ...
  call sf_3_g5( g5_z_yy, g5_deriv_z_yy, &
                eta5_z_yy, R_s_z_yy, zeta5_z_yy, num_g5_z_yy, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
                posi2(atom2,1), posi2(atom2,2), posi2(atom2,3), &
                natom, natom_x, natom_y, natom_z, &
...
elseif( natom_x < j .and. j <= natom_x + natom_y .and. &
  ...
  call sf_3_g5( g5_z_yz, g5_deriv_z_yz, &
                eta5_z_yz, R_s_z_yz, zeta5_z_yz, num_g5_z_yz, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
                posi2(atom2,1), posi2(atom2,2), posi2(atom2,3), &
                natom, natom_x, natom_y, natom_z, &
...
elseif( natom_x + natom_y < j .and. j <= natom_x + natom_y + natom_z .and. &
  ...
  call sf_3_g5( g5_z_zz, g5_deriv_z_zz, &
                eta5_z_zz, R_s_z_zz, zeta5_z_zz, num_g5_z_zz, &
                posi1(i,1),     posi1(i,2),     posi1(i,3), &
                posi2(atom1,1), posi2(atom1,2), posi2(atom1,3), &
                posi2(atom2,1), posi2(atom2,2), posi2(atom2,3), &
                natom, natom_x, natom_y, natom_z, &
...
do j = 1, natom
do i = 1, natom_x
if( isnan( g5_deriv_x_xx(i,j,k,l) ) ) then
  write(*,"(I5,I5,I5,I5)") i, j, k, l
  stop 'NaN g5_deriv_x_xx'
end if
enddo
enddo
enddo
