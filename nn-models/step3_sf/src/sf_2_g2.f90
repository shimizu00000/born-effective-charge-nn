subroutine sf_2_g2( g2, g2_deriv, eta2, rs2, num_g2, &
                    posi1_x, posi1_y, posi1_z, &
                    posi2_x, posi2_y, posi2_z, &
                    natom, natom_x, natom_y, &
                    Rij, i, j, rc, natom_t )
implicit none
integer i, j, ig2, num_g2, ii
integer natom, natom_t
integer natom_x, natom_y, natom_z
double precision g2( natom_t, num_g2 ), g2_deriv( natom_t, natom, 3, num_g2 ) 
