subroutine sf_2_g5( g5, g5_deriv, &
                    eta5, lambda5, zeta5, num_g5, &
                    posi1_x,   posi1_y,   posi1_z, &
                    posi2_j_x, posi2_j_y, posi2_j_z, &
                    posi2_k_x, posi2_k_y, posi2_k_z, &
                    natom, natom_x, natom_y, &
                    Rij, Rik, i, j, k, rc, natom_t )
implicit none
integer i, j, k, ig5, num_g5, ii
integer natom, natom_t
integer natom_x, natom_y
double precision g5( natom_t, num_g5 ), g5_deriv( natom_t, natom, 3, num_g5 )
