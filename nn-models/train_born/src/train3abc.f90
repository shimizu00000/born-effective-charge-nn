subroutine train3abc( &
  ...
  weight_z, weight_inv_z, nweight_z, hidden_z, nhidden_z, &
  beta, g_e_x, g_f_x, g_e_y, g_f_y, g_e_z, g_f_z, &
...
double precision weight_z( nweight_z ), weight_inv_z( nweight_z )
...
double precision g_e_z( nweight_z ), g_f_z( nweight_z ), energy_z
...
!Z-X, Z-Y, Z-XY
 ...
 !-----------------------------------------------------
 g_e_x = 0.0d0; g_e_y = 0.0d0; g_e_z = 0.0d0
 g_f_x = 0.0d0; g_f_y = 0.0d0; g_f_z = 0.0d0
 !X
 if( io_x == 1 )then
 call f_ef_deriv3abc( &
      g2_x_x,  g2_deriv_x_x,  num_g2_x_x, &
 ...
 call f_ef_deriv3abc( &
      ...
      beta, g_e_y, g_f_y, &
      natom, natom_y, energy, energy0, force, force0 )
 endif
 !Z
 if( io_z == 1 )then
 call f_ef_deriv3abc( &
      ...
      g5_z_zz, g5_deriv_z_zz, num_g5_z_zz, &
      num_g_z, &
      network_z, nlayer_z, weight_z, weight_inv_z, nweight_z, hidden_z, nhidden_z, &
      beta, g_e_z, g_f_z, &
      natom, natom_z, energy, energy0, force, force0 )
 endif


end subroutine train3abc
